...
fn build_apple() {
    ...
    let swift_source = manifest_dir.join("src/sys/apple/CameraHelper.swift");
    ...
    let pkg_h = out_dir.join("waterkit-camera/waterkit-camera.h");
    ...
    let gen_swift = out_dir.join("waterkit-camera/waterkit-camera.swift");
    let combined_swift = out_dir.join("CombinedCamera.swift");
    ...
    let impl_content = fs::read_to_string(&swift_source).expect("Failed to read CameraHelper.swift");
    ...
    let obj_file = out_dir.join("CameraHelper.o");
    ...
    let lib_file = out_dir.join("libCameraHelper.a");
    ...
    println!("cargo:rustc-link-lib=static=CameraHelper");
...
fn build_android() {
    const KOTLIN_FILE_RELATIVE_PATH: &str = "src/sys/android/CameraHelper.kt";
